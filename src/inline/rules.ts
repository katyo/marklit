...
export interface InlineContextMap<InlineToken> {
    [InlineContext.Top]: [InlineTokenType<InlineToken>, InlineMeta];
    [InlineContext.Link]: [InlineTokenType<InlineToken>, InlineMeta];
}

export type InlineRule<InlineToken> = ParserRule<InlineContextMap<InlineToken>, InlineContext>;

export type InlineHandle<InlineToken> = ParserHandle<InlineContextMap<InlineToken>, InlineContext>;
